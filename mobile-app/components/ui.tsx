...
export function PageHeader({
  ...
  return (
    <header className="mobile-page-header pad flex items-center gap-3">
      <Link
        href={back}
        aria-label="Go back"
        className={`mobile-back shrink-0 w-10 h-10 grid place-items-center rounded-full ${topLevel ? "top-level-back" : ""}`}
      >
      ...
      <div className="min-w-0 flex-1">
        ...
        <h1
          className="display text-[1.45rem] leading-tight"
...
export function EmptyState({
  ...
  return (
    <div className="panel p-8 text-center empty-state">
