...
export default async function AccountPage() {
  ...
  return (
    <main className="with-nav">
      <header className="mobile-profile-hero pad text-center">
        ...
        <div className="flex flex-wrap justify-center gap-2 mt-3">
          {roles.map((r) => (
            <Pill key={r} color="#00877d">
              {r.toLowerCase()}
            </Pill>
          ))}
          {user.verified ? <Pill color="#338346">verified</Pill> : null}
        </div>
      </header>

      <section className="pad">
        <div className="mobile-wallet-card card p-5" style={{ borderColor: "#00877d44" }}>
          <div className="flex items-center gap-2">
            <Wallet size={16} style={{ color: "#00877d" }} />
            <p className="text-xs text-[var(--color-mist)]">Wallet balance</p>
          </div>
          <p className="display text-3xl mt-1.5" style={{ color: "#00877d" }}>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-right shrink-0">
                      <p
                        ...
                        style={{ color: incoming ? "#338346" : "#142422" }}
                      >
                        {incoming ? "+" : "−"}
      ...
      <section className="pad mt-8">
        ...
        <form action={logoutAction}>
          <button className="btn btn-ghost w-full" style={{ color: "#db4d30" }}>
