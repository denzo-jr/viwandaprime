...
export default async function HomePage() {
  ...
  return (
    <main className="with-nav">
      {/* Operations header */}
      <header className="pad min-h-[76px] lg:min-h-[94px] py-3 flex items-center justify-between gap-4 bg-white border-b border-[var(--color-line)]">
        <div className="min-w-0">
          <Eyebrow>Factory / Overview</Eyebrow>
          <h2 className="display text-[1.15rem] lg:text-[1.25rem] truncate">
            Operations overview
          </h2>
        </div>
      ...
      <div className="pad pt-8">
        ...
        <section className="mb-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-[15px]">
            {MODULES.map((m) => (
              <Link key={m.slug} href={m.href} className="panel card-lift p-5">
                <span
