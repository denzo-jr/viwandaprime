...
export default async function NewMachinePage() {
  ...
  return (
    <main className="pb-20">
      ...
      <form action={createMachineAction} className="pad flex flex-col gap-5 mt-2">
        <div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2">
            <label className="card p-3 text-center cursor-pointer">
              ...
              />
              <span className="block text-sm font-semibold peer-checked:text-[#0ea5e9]">
                Rent out
              </span>
            </label>
            <label className="card p-3 text-center cursor-pointer">
              <input type="radio" name="kind" value="SALE" className="sr-only peer" />
              <span className="block text-sm font-semibold peer-checked:text-[#22c55e]">
                Sell
              </span>
            </label>
          </div>
